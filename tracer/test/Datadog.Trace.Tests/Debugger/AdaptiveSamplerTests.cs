...
{
    private static readonly TimeSpan WindowDuration = TimeSpan.FromSeconds(value: 1);
    ...
    {
        var sampler = new AdaptiveSampler(TimeSpan.Zero, samplesPerWindow: 2, averageLookback: 1, budgetLookback: 1, rollWindowCallback: null);
